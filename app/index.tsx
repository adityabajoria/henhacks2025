  ...
  return (
    <View style={[styles.container, theme === 'dark' ? styles.darkContainer : styles.lightContainer]}>
      ...
      <Animated.View style={{ ...styles.logoContainer, opacity: fadeAnim, transform: [{ scale: scaleAnim }] }}>
        <Image 
          source={theme === 'dark' ? require('../assets/images/logo.png') : require('../assets/images/logo_dark.png')} 
          style={styles.logo} 
        />
      </Animated.View>
      {/* App Name */}
      <Text style={[styles.text, theme === 'dark' ? styles.darkText : styles.lightText]}>Valv-AI</Text>
    </View>
  );
}
